		...
		<div class="row">
			<div class="col-md-6">
				<div>
					...
					<p>
						We are your specialist in online therapy and counseling.
					</p>
					<p>
						Use our services from the comfort of your home or office. It’s easy, safe and affordable.
					</p>
					<p>
						Start today! Talk with a qualified psychologist or counselor by e-mail, chat, videoconferencing or
						phone.
					</p>
					...
					<div class="mt-2">
						<img class="scale-with-grid" src="{{ asset('assets/images/resource/mental-health.webp') }}"
							alt="Get mental health care from home!" />
					</div>
					<h2>The Many Benefits of Online Therapy</h2>
					<p>Online therapy offers you numerous benefits.</p>
					<ul>

						<li>Efficient time-management: never again will you waste time in traffic jams, trying to get to a
							counselor’s consulting room on time.
						</li>
						...
						<li>Many options of therapists and psychologists: In our team you will find specialists from all the most
							important areas of psychology and psychotherapy. Choose the expert according to your needs!
						</li>
						...
						<li>Save money: We provide professional counseling at affordable fees. Get the help you need at a lower
							cost!</li>


						<br>

						<li>Continuity: Are you changing city or neighborhood? It doesn't matter, you can keep the same therapist
							with whom you already started to talk.</li>



						<br>

						<li>Positive treatment results: Several clinical studies worldwide have shown that online therapy is a very
							effective treatment. In fact, it is as efficient as the more traditional forms of face-to-face
							psychotherapy, and its results can be durable.
						</li>

						<br>

						<li>
							Privacy and comfort: Use our services from your home or office. Choose the time that you like best. Choose
							the communication channel. You control the process and the level of privacy at all times.
						</li>
					...
					<div>
						<img class="scale-with-grid" src="{{ asset('assets/images/resource/tablet-new.webp') }}"
							alt="Psychotherapy from distance is efficient!">
					</div>
				</div>
			</div><!-- FIN COLUMNA1 -->
			<div class="col-md-6">
				<div class="info">
					...
					<p>
						Our customer service center is confidential and free of charge. We'll be happy to tell you more about our
					...
					<p>
						<img class="scale-with-grid" src="{{ asset('assets/images/resource/psychotherapy-done-remotely.webp') }}"
							alt="Online therapy works for me!">
					</p>

					<h3>TRAINING FOR COUNSELORS</h3>
					...
					<p>
						<a class="link small" href="./training-for-counselors.php">Methods in Online Counseling</a>
					</p>
					...
					<ul class="external-links">
						...
						<li> <a href="/news.php"> Therapion in the Press
							</a>
						</li>
						<li>
							<a href="https://onlinetherapyarticles.wordpress.com">
								Article: Life in the time of Covid-19
							</a>

						</li>
					</ul>
					<h3>FREE LIVE EVENTS - SUMMER 2021</h3>
					<p>
					...
					<p>
						<a class="link" href="./formcustomerservice.php">Enroll To The Upcoming Event</a>
					</p>
					<p>
						<a class="link" href="./live-show.php">Read More About Our Live Events</a>
					</p>
